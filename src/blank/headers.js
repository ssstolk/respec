/*
    Copy of w3c/headers.js with slight modifications:
    * Disabled sotd imports and population.
    * Set logos used to an empty array in all cases.
    * Disabled license message (use configSpec attribute "overrideCopyright" instead).
    * The variable prependW3C is always set to false
    -- ssstolk, 2018-09-18
*/
